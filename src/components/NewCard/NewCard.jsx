...
import {
    ...
    CardCategoryItemHousing,
    CardCategoryItemJoy,
    CardCategoryItemOthers,
    CardCategoryItems,
    CardCategoryItemTransport,
    CardDateHeader,
    CardForm,
    CardFormButton,
    CardFormDate,
            ...
            <CardForm onSubmit={handleSubmit}>
                ...
                <CardCategoryItems>
                    ...
                    >
                        ...
                        <ItemName>Транспорт</ItemName>
                    </CardCategoryItemTransport>
                    <CardCategoryItemHousing
                        onClick={() => {
                            setActiveCategory(
                                activeCategory === 'housing' ? null : 'housing'
                            )
                        }}
                        $isActive={activeCategory}
                    >
                        ...
                        <ItemName>Жилье</ItemName>
                    </CardCategoryItemHousing>
                    <CardCategoryItemJoy
                        onClick={() =>
                            setActiveCategory(
                                activeCategory === 'joy' ? null : 'joy'
                            )
                        }
                        $isActive={activeCategory}
                    >
                    ...
                    >
                        ...
                        <ItemName>Образование</ItemName>
                    </CardCategoryItemEducation>
                    <CardCategoryItemOthers
                        onClick={() =>
                            setActiveCategory(
                                activeCategory === 'others' ? null : 'others'
                            )
                        }
                        $isActive={activeCategory}
                    >
                        ...
                        >
                            <path
                                d="M9.33332 1.6665H4.66666C2.33332 1.6665 1.16666 2.83317 1.16666 5.1665V12.7498C1.16666 13.0707 1.42916 13.3332 1.74999 13.3332H9.33332C11.6667 13.3332 12.8333 12.1665 12.8333 9.83317V5.1665C12.8333 2.83317 11.6667 1.6665 9.33332 1.6665ZM8.16666 9.39567H4.08332C3.84416 9.39567 3.64582 9.19734 3.64582 8.95817C3.64582 8.719 3.84416 8.52067 4.08332 8.52067H8.16666C8.40582 8.52067 8.60416 8.719 8.60416 8.95817C8.60416 9.19734 8.40582 9.39567 8.16666 9.39567ZM9.91666 6.479H4.08332C3.84416 6.479 3.64582 6.28067 3.64582 6.0415C3.64582 5.80234 3.84416 5.604 4.08332 5.604H9.91666C10.1558 5.604 10.3542 5.80234 10.3542 6.0415C10.3542 6.28067 10.1558 6.479 9.91666 6.479Z"
                                fill="black"
                            />
                        </svg>
                        <ItemName>Другое</ItemName>
                    </CardCategoryItemOthers>
                </CardCategoryItems>
